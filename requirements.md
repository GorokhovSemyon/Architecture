...
### 6. Ограничения
**Технологический стек** - API должно быть реализовано на Python 3.12+ с использованием FastAPI framework, использовать SQLAlchemy в качестве ORM для работы с PostgreSQL, JWT для аутентификации, Pydantic для валидации данных и развертываться в Docker-контейнерах.